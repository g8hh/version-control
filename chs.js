...
var cnRegReplace = new Map([
    ...
    [/^Get (.+) Joints$/, '获得 $1 关节'],
    [/^Get (.+) XP$/, '获得 $1 经验'],
    [/^Spend (.+) Screws and (.+) Joints for (.+) Rods$/, '花 $1 螺钉和 $2 接头获得 $3 棒子'],
    [/^Spend (.+) Beams and (.+) Beams for (.+) Towers$/, '花 $1 木梁和 $2 宝石获得 $3 塔'],
    [/^Spend (.+) Rods for (.+) Gems$/, '花费 $1 棒子换 $2 宝石'],
    [/^Spend (.+) Rods for (.+) Towers$/, '花费 $1 棒子换 $2 塔'],
