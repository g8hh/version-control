...
var cnRegReplace = new Map([
    ...
    [/^Spend (\d+) Rocks for (\d+) Rods$/, '花费 $1 石头获得 $2 鱼竿'],
    ...
    [/^Spend (\d+) Screws for (\d+) Rods$/, '花费 $1 螺丝获得 $2 鱼竿'],
    ...
    [/^Spend (\d+) Screws for (\d+) DP$/, '花费 $1 螺丝获得 $2 DP'],
    [/^Spend (\d+) Rods for (\d+) Roads$/, '花费 $1 鱼竿获得 $2 道路'],
    [/^Spend (\d+) Rods for (\d+) HP$/, '花费 $1 鱼竿获得 $2 生命值'],
    [/^Spend (\d+) Boards for (\d+) HP$/, '花费 $1 板子获得 $2 生命值'],
    [/^Spend (\d+) Boards for (\d+) DP$/, '花费 $1 板子获得 $2 DP'],
    ...
    [/^Spend (\d+) Boards for (\d+) Rods$/, '花费 $1 板子获得 $2 鱼竿'],
    [/^Spend (\d+) Boards for (\d+) Roads$/, '花费 $1 板子获得 $2 道路'],
    [/^Spend (\d+) Boards for (\d+) Joints$/, '花费 $1 板子获得 $2 关节'],
    [/^Spend (\d+) Gems for (\d+) DP$/, '花费 $1 宝石获得 $2 DP'],
    [/^Spend (\d+) Beams for (\d+) DP$/, '花费 $1 横梁获得 $2 DP'],
    [/^Spend (\d+) Beams for (\d+) Rods$/, '花费 $1 横梁获得 $2 鱼竿'],
    [/^Spend (\d+) Beams for (\d+) HP$/, '花费 $1 横梁获得 $2 生命值'],
    [/^Spend (\d+) Beams for (\d+) Roads$/, '花费 $1 螺丝获得 $2 道路'],
    [/^Spend (\d+) Towers for (\d+) DP$/, '花费 $1 塔获得 $2 DP'],
    ...
    [/^Spend (\d+) Boards and (\d+) Screws for (\d+) Rods$/, '花费 $1 板子和 $2 螺丝 获得 $3 鱼竿'],
    ...
    [/^Spend (\d+) Beams and (\d+) Rods for (\d+) Ships$/, '花费 $1 横梁和 $2 鱼竿 获得 $3 船'],
    [/^Spend (\d+) Beams and (\d+) Rods for (\d+) Gems$/, '花费 $1 横梁和 $2 鱼竿 获得 $3 宝石'],
    [/^Spend (\d+) Screws and (\d+) Beams for (\d+) Nukes$/, '花费 $1 螺丝和 $2 横梁 获得 $3 核子'],
    [/^Spend (\d+) Screws and (\d+) Rods for (\d+) Gems$/, '花费 $1 螺丝和 $2 鱼竿 获得 $3 宝石'],
    [/^Spend (\d+) Bars and (\d+) Rods for (\d+) Ships$/, '花费 $1 金属条和 $2 鱼竿 获得 $3 船'],
    [/^Spend (\d+) Bars and (\d+) Rods for (\d+) Towers$/, '花费 $1 金属条和 $2 鱼竿 获得 $3 塔'],
    [/^Spend (\d+) Bars and (\d+) Screws for (\d+) Rods$/, '花费 $1 金属条和 $2 螺丝 获得 $3 鱼竿'],
    ...
    [/^Spend (\d+) Joints and (\d+) Beams for (\d+) Gems$/, '花费 $1 关节和 $2 横梁 获得 $3 宝石'],
    [/^Spend (\d+) Joints and (\d+) Rods for (\d+) Gems$/, '花费 $1 关节和 $2 鱼竿 获得 $3 宝石'],
    [/^Spend (\d+) Rods and (\d+) Towers for (\d+) Nukes$/, '花费 $1 鱼竿和 $2 塔 获得 $3 核子'],
    ...
    [/^Spend (\d+) Beams for (\d+) DP$/, '花费 $1 螺丝获得 $2 DP'],
    [/^Spend (\d+) Roads for (\d+) DP$/, '花费 $1 道路获得 $2 DP'],
    ...
    [/^Spend (\d+) Rods for (\d+) Nukes$/, '花费 $1 鱼竿获得 $2 核子'],
    [/^Cost: (.+) Boards$/, '成本: $1 板子'],
    [/^Cost: (.+) Bars$/, '成本: $1 金属条'],
    [/^Cost: (.+) Logs$/, '成本: $1 木头'],
    [/^Cost: (.+) Joints$/, '成本: $1 关节'],
